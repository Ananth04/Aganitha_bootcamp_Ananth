//Provide an example of how to use these functions.
//Call fetchMultipleUsers with an array of user IDs to demonstrate the asynchronous fetching and processing of user data.
